...
bin/cRace: bin/main.o bin/Agent.o bin/Graph.o bin/SelectionPolicy.o bin/EdgeWeightSelectionPolicy.o bin/MandatesSelectionPolicy.o bin/JoinPolicy.o bin/MandatesJoinPolicy.o bin/LastOfferJoinPolicy.o bin/Parser.o bin/Party.o bin/Simulation.o bin/Coalition.o 
	g++ -o bin/cRace bin/main.o bin/Agent.o bin/Graph.o bin/SelectionPolicy.o  bin/EdgeWeightSelectionPolicy.o bin/MandatesSelectionPolicy.o bin/JoinPolicy.o bin/MandatesJoinPolicy.o bin/LastOfferJoinPolicy.o bin/Parser.o bin/Party.o bin/Simulation.o bin/Coalition.o
